...
I would strongly suggest that you use branches extensively in your day-to-day workflow. Branches are one of the core concepts that Git was built around. They are extremely cheap and easy to create, and simple to manage—and there are [plenty of resources][1] out there if you’re ready to learn more about using them.
...
(For more detail about the `amend` option, I recommend Nick Quaranto’s [excellent walkthrough][2].)
